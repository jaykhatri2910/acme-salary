                ...
                <div key={dept.department} className="space-y-2 group">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-sm">
                    ...
                    <div className="flex items-center space-x-3 text-xs text-muted-foreground">
                      <span>
                        Payroll: <strong className="text-foreground">{formatUsd(totalPayroll)}</strong>
                      </span>
                      <span>·</span>
                      <span>
                        Avg: <strong className="text-indigo-600 dark:text-indigo-300 font-semibold">{formatUsd(avgSalary)}</strong>
                      </span>
                    </div>
                  </div>
